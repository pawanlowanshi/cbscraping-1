...
public class ExcelUtils {
	...
	public static Boolean asBoolean(XSSFSheet sheet, int rowIndex, int colIndex) {
		if ("pass".equalsIgnoreCase(sheet.getRow(rowIndex).getCell(colIndex).toString()) || "true".equalsIgnoreCase(sheet.getRow(rowIndex).getCell(colIndex).toString())||"1".equalsIgnoreCase(sheet.getRow(rowIndex).getCell(colIndex).toString()))
	...
	public static void setDate(XSSFSheet sheet, int rowIndex, int colIndex, Date value) {
		sheet.getRow(rowIndex).getCell(colIndex).setCellValue(value);
	}

	public static void setValue(XSSFSheet sheet, int rowIndex, int colIndex, String value) {
	...
	public static String asStringByName(XSSFWorkbook wb, XSSFSheet sheet, int rowIndex, String name) {
	...
	public static Cell asCellByName(XSSFWorkbook wb, XSSFSheet sheet, int rowIndex, String name) {
