...
public class ExcelUtils {
	...
	public static String getCellValByIndex(XSSFSheet sheet, int rowIndex,
			int colIndex) {
	...
	public static Boolean getCellBooleanByIndex(XSSFSheet sheet, int rowIndex,
			int colIndex) {
	...
	public static Date getCellDateByIndex(XSSFSheet sheet, int rowIndex,
			int colIndex) {
		return sheet.getRow(rowIndex).getCell(colIndex).getDateCellValue();
	}

	public static void setExcelCellDate(XSSFSheet sheet, int rowIndex,
			int colIndex, Date value) {
		sheet.getRow(rowIndex).getCell(colIndex).setCellValue(value);
	}

	public static void setExcelCellValue(XSSFSheet sheet, int rowIndex,
	...
	public static String getCellValByName(XSSFWorkbook wb, XSSFSheet sheet,
	...
	public static Cell getCellByName(XSSFWorkbook wb, XSSFSheet sheet,
			int rowIndex, String name) {
